...
describe Admin::MarketsController do
  ...
  describe "GET index" do
    it "assigns all admin_markets as @admin_markets" do
      ...
      assigns(:admin_markets).should eq([market])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested admin_market as @admin_market" do
      ...
      assigns(:admin_market).should eq(market)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin_market as @admin_market" do
      ...
      assigns(:admin_market).should be_a_new(Admin::Market)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Admin::Market" do
        expect {
          post :create, {:admin_market => valid_attributes}, valid_session
        }.to change(Admin::Market, :count).by(1)
      end

      it "assigns a newly created admin_market as @admin_market" do
        post :create, {:admin_market => valid_attributes}, valid_session
        assigns(:admin_market).should be_a(Admin::Market)
        assigns(:admin_market).should be_persisted
      end

      it "redirects to the created admin_market" do
        post :create, {:admin_market => valid_attributes}, valid_session
        response.should redirect_to(Admin::Market.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_market as @admin_market" do
        ...
        Admin::Market.any_instance.stub(:save).and_return(false)
        post :create, {:admin_market => { "name" => "invalid value" }}, valid_session
        assigns(:admin_market).should be_a_new(Admin::Market)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_market" do
        market = Admin::Market.create! valid_attributes
        # Assuming there are no other admin_markets in the database, this
        # specifies that the Admin::Market created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Admin::Market.any_instance.should_receive(:update_attributes).with({ "name" => "" })
        put :update, {:id => market.to_param, :admin_market => { "name" => "" }}, valid_session
      end

      it "assigns the requested admin_market as @admin_market" do
        market = Admin::Market.create! valid_attributes
        put :update, {:id => market.to_param, :admin_market => valid_attributes}, valid_session
        assigns(:admin_market).should eq(market)
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_market as @admin_market" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Market.any_instance.stub(:save).and_return(false)
        put :update, {:id => market.to_param, :admin_market => { "name" => "invalid value" }}, valid_session
        assigns(:admin_market).should eq(market)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the admin_markets list" do
      market = Admin::Market.create! valid_attributes
      delete :destroy, {:id => market.to_param}, valid_session
      response.should redirect_to(admin_markets_url)
    end
  end
